...
echo -e "\e[1;31m2) Installing simpleadmin from the $GITTREE branch\e[0m"
			...
			wget $GITROOT/simpleadmin/www/js/sidebar.js
    		sleep 1
			...
			wget $GITROOT/simpleadmin/www/cgi-bin/get_watchcat_logs
			wget $GITROOT/simpleadmin/www/cgi-bin/get_watchcat_info
